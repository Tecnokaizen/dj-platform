...
export function createSuspendOrganization(client: OrganizationMutationClient) {
  return async function suspendOrganizationRecord(
...
export async function suspendOrganization(
  ...
  return runAuthorizedOrganizationOperation({
    ...
    execute: async (client) =>
      createSuspendOrganization(client)(organizationId),
  })
}
